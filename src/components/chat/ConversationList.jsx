...
export default function ConversationList({ 
  ...
  const conversationItemStyles = (isSelected) => ({
    ...
    border: isSelected ? '1px solid rgba(58, 134, 255, 0.3)' : '1px solid transparent',
    ...
    <div style={containerStyles}>
      {conversations.map((conversation) => {
        ...
        return (
          <div
            key={conversation.id}
            style={conversationItemStyles(isSelected)}
          ...
          >
            ...
            <div style={conversationInfoStyles}>
              ...
              <div style={usernameStyles}>
                {conversation.nickname ? `@${conversation.nickname}` : 'No recent messages'}
              </div>
            </div>
          </div>
        );
